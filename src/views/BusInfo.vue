			...
			<div class="p-2 flex flex-col gap-3 justify-start md:w-[340px] border-t-4 border-greenRegular">
				...
				<div class="flex justify-center">
					<button
						...
						@click="onClickSearch()"
						class="inline-flex items-center justify-center w-3/5 py-4 text-base font-medium leading-6 text-white transition duration-150 ease-in-out bg-greenRegular border border-transparent rounded-md sm:hover:bg-greenLight sm:hover:text-greenDark focus:outline-none active:bg-red-300"
					>
